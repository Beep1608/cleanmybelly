...
| [5. Deployment Playbook](deployment_playbook.md) | Step-by-step setup sequence, secrets lookup with SSM, and cache invalidation. | Setup order, CLI commands, GitHub Actions, Parameter Store |
| [6. Pipelines](../manuals/pipelines/README.md) | Reusable CI/CD workflow configurations and step-by-step setups for GitHub Actions OIDC federation. | GitHub Actions, AWS OIDC Trust, YAML blueprints |
